...
elseif (devicechanged[detection] or devicechanged[detection2]) and devicechanged[detection] == 'Off' and devicechanged[detection2] == 'Off' and otherdevices[force] == 'Off' then
    commandArray['Group:' .. lampes] = 'Off'
    print('Garage - plus personne')
-- Quelqu'un arrive dans le garage
elseif (devicechanged[detection] or devicechanged[detection2]) and (devicechanged[detection] == 'On' or devicechanged[detection2] == 'On') then
    commandArray['Group:' .. lampes] = 'On'
